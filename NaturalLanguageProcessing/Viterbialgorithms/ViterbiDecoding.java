public class ViterbiDecoding {
	private static String[] states = {"hot","cold" };
	
	private static String[] observations = { "3", "3", "1","1","2","2","3","1","3" };
	private static double[] start_probability = {0.8,0.2 };
	private static double[][] transition_probability = { { 0.7, 0.3 },
			{ 0.4,0.6}};
	private static double[][] emission_probability = { { 0.2,0.4,0.4},
			{ 0.5,0.4,0.1}};
	...
	public int[] forwardViterbi(String[] y, String[] X, double[] sp,
		...
		System.out.print("ViterbiDecoding path: [");
	...
	public static void main(String[] args) throws Exception {
		...
		ViterbiDecoding v=new ViterbiDecoding();
